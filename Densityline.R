...
if (is.numeric(skoda_data$price) && length(skoda_data$price) > 0) {
  # Plot histogram
  hist(skoda_data$price, probability = TRUE, col = "lightblue",
       border = "black", breaks = 30,main = "Density Curve for Histogram of Resale Price", xlab = "Resale Price", ylab = "Frequency")
